...
// 初始化存储的数据结构
// robotID，位置positionX，positionY，速度值v
type RobotAsset struct {
	RobotId   string  `json:"robotId"`   //RobotID
	PositionX string  `json:"positionX"` //位置x
	PositionY string  `json:"positionY"` //位置y
